...
- [x] User can logout and be send back to the login page
- [x] User can see a launch page
...
<img src='https://github.com/MarioMartinezA/ParseChat/blob/master/demo/ParseChatDemo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
